...
const SignIn = () => {
    ...
    const onSubmit = (e) => {
        ...
        signIn(user).then(response => console.log(response)).catch(err => console.log(err))
    }
    return (
                ...
                <div className="form">
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="inputBox">
                            <input type="text" placeholder="username" className={errors.username ? "error" : "success"} value={values.userName}/>
                            <div className="icon"><Icon icon="bx:bxs-user" /></div>
                            <span>Error</span>
                        </div>
                        <div className="inputBox">
                            <input type="password" placeholder="password" className={errors.password ? "error" : "success"} value={values.password} onChange={onChange()}/>
