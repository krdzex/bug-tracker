                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="right">
                                <input list="ice-cream-flavors" id="ice-cream-choice" name="ice-cream-choice" onMouseDown={() => setValues({ priority: "" })} value={values.priority} onKeyDown={(event) => {
                                    event.preventDefault();
                                }} onChange={onChange("priority")} />
                                <datalist id="bugPriorit">
                                    <option value="Low" />
                                    <option value="Medium" />
                                    <option value="High" />
                                </datalist>
