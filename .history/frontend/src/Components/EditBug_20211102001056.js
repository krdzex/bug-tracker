...
const EditBug = () => {
    ...
    const onEditClick = () =>{
        let bug = {
            name: bugInfo.name || undefined,
            details: bugInfo.details || undefined,
            steps: bugInfo.steps || undefined,
            priority: bugInfo.priority || undefined,
            assigned: bugInfo.assigned || undefined,
            version: bugInfo.version || undefined
        }
        editBug(bugInfo._id,bug)
    }
    return (
