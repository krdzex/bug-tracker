...
const SingleBug = () => {
    ...
    const onComplete = () => {
        completeBug(bugInfo._id).then(response => {
            dispatch(openPopUp("Successfuly completed bug!"))
            setTimeout(() => {
                dispatch(closePopUp())
            }, 3000);
            dispatch(changeShow("allBugs"))
        ...
        <div className="singleBugWrapper">
            <div className="bugCard">
                ...
                <div className="buttons">
                    ...
                    {bugInfo.complete &&(<button id="edit" onClick={() => dispatch(changeShow("edit"))}>
                        Edit
                    </button>)}
                    {bugInfo.complete &&(<button id="complete" onClick={() => onComplete()}>
                        Complete
                    </button>}
