                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="right"><input type="text" value={assigned.creator} disabled onChange={onChange("creator")} /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="right"><input type="text" value={bugInfo.assigned} onChange={onChange("version")} /></td>
                        </tr>
                        <tr>
                            <td className="left">Time created:</td>
                            <td className="right"><input type="text" value={values.time} disabled onChange={onChange("time")} /></td>
                        </tr>
                    </tbody>
                </table>
