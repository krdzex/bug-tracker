                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="right"><input type="text" value={values.priority} onChange={() =>onChange("name")}/></td>
                        </tr>
                        <tr>
                            <td className="left">Creator:</td>
                            <td className="right"><input type="text" value={values.creator} onChange={() =>onChange("creator")}/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="right"><input type="text" value={values.time} onChange={() =>onChange("time")}/></td>
                        </tr>
                    </tbody>
                </table>
