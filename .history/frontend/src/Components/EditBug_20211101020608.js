...
const EditBug = () => {
    ...
    const onRelease = () => {
        if (values.priority === "") {
            setValues({ priority: bugInfo.priority })
        }
    }
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="right">
                                <input type="text" list="bugPriority" onMouseDown={() => setValues({ priority: "" })} value={values.priority}  onChange={onChange("priority")} onBlur={() => onRelease()} />
