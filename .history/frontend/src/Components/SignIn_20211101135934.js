                ...
                <div className="form">
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="inputBox datalist">
                            <input type="text" list="role" className={errors.role ? "error" : "success"} placeholder="Choose your role" onMouseDown={() => setValues({ ...values, role: "" })} value={values.priority} onKeyDown={(event) => {
