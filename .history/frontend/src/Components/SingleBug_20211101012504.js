                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="right">
                            <input list="ice-cream-flavors" id="ice-cream-choice" name="ice-cream-choice" onChange={onChange} value={da}/>
                                <datalist id="ice-cream-flavors">
                                    <option value="Option 1" onClick={setDa("Option 1")}/>
                                    <option value="Option 2"  onClick={setDa("Option 2")}/>
                                    <option value="Option 3" onClick={setDa("Option 1")}/>
                                </datalist>
                            </td>
                        </tr>
                        <tr>
